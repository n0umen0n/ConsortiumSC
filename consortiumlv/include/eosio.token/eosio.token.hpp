...
namespace eosio {
    ...
    * @{
    */
   class [[eosio::contract("eosio.token")]] consortiumlv : public contract {
      public:
...
[[eosio::action]]
void genesisdistr( name owner, asset quantity );
         /**
          * Retire action.
          * 
         ...
         using create_action = eosio::action_wrapper<"create"_n, &consortiumlv::create>;
         using issue_action = eosio::action_wrapper<"issue"_n, &consortiumlv::issue>;
         using retire_action = eosio::action_wrapper<"retire"_n, &consortiumlv::retire>;
         using transfer_action = eosio::action_wrapper<"transfer"_n, &consortiumlv::transfer>;
         using open_action = eosio::action_wrapper<"open"_n, &consortiumlv::open>;
         using close_action = eosio::action_wrapper<"close"_n, &consortiumlv::close>;
      private:
